...
Riemann_solver = "exact"; % Either "HLLC" or "exact"
...
% Generating mesh:
[x,dx] = generate_mesh(L,N,"Godunov",-L/2); % [m], [m]
...
switch solver
    case "Godunov"
        [vars,gas,tvec] = SOLVER_Godunov(vars,A_f,dAdx_f,x,dx,t_end,sigma,NaN,NaN,NaN,NaN,BCs,Riemann_solver, ...
            gas_model,Rg_0,gamma_0,species,n_0);
    case "MUSCL_Hancock"
        [vars,gas,tvec] = SOLVER_MUSCL_Hancock(vars,A_f,dAdx_f,x,dx,t_end,sigma,w,NaN,NaN,NaN,NaN,BCs,Riemann_solver, ...
            gas_model,Rg_0,gamma_0,species,n_0);
end
solver_time = toc;
