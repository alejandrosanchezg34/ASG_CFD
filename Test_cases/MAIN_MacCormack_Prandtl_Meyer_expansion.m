...
% Select MacCormack scheme to use:
solver = "space_marching"; % Either "time_marching" or "space_marching"
...
switch solver
    case "time_marching"
        [vars,gas,tvec] = SOLVER_MacCormack_time(vars,A_f,dAdx_f,x,dx,t_end,sigma,rho_inf,u_inf,p_inf,NaN,Cx,BCs, ...
            gas_model,Rg_inf,gamma_inf,species,n_inf);
    case "space_marching"
        [vars,gas] = SOLVER_MacCormack_space(vars,A_f,dAdx_f,x,dx,gas_model,Rg_inf,gamma_inf,species,n_inf);
end
solver_time = toc;
